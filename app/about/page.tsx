...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-10 sm:mb-16">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-[#E50914]/5 border border-[#E50914]/20 mb-4 sm:mb-6">
                <span className="w-2 h-2 rounded-full bg-[#E50914]" />
      ...
      {/* Vision & Mission */}
      <section className="relative py-16 sm:py-24 md:py-32 overflow-hidden bg-gray-50 dark:bg-gray-950">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
              {/* Vision */}
              <div className="group relative bg-white dark:bg-gray-900 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 border-2 border-gray-200 dark:border-gray-800 hover:border-[#E50914] transition-all duration-500 overflow-hidden">
                ...
                <div className="relative">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-[#E50914] rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                    <Eye className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" />
                  </div>
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 text-gray-900 dark:text-white">Our Vision</h2>
                  <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              <div className="group relative bg-white dark:bg-gray-900 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 border-2 border-gray-200 dark:border-gray-800 hover:border-[#E50914] transition-all duration-500 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 text-gray-900 dark:text-white">Our Mission</h2>
                  <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
      ...
      {/* Team Section */}
      <section className="relative py-16 sm:py-24 md:py-32 overflow-hidden bg-gray-900">
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-[#E50914]/10 rounded-full blur-3xl" />
          <div className="absolute bottom-0 right-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-[#E50914]/5 rounded-full blur-3xl" />
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
              {teamMembers.map((member, index) => (
                <div
                  key={index}
                  className="group relative bg-white/5 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-white/10 hover:border-[#E50914]/50 hover:bg-white/10 transition-all duration-300 text-center"
                >
                  {/* Avatar */}
                  <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-gradient-to-br from-[#E50914] to-[#ff4d5a] rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-5 group-hover:scale-110 transition-transform duration-300">
                    <span className="text-xl sm:text-2xl md:text-3xl font-bold text-white">{member.initials}</span>
                  </div>

                  {/* Info */}
                  <h3 className="text-base sm:text-lg md:text-xl font-bold text-white mb-0.5 sm:mb-1">{member.name}</h3>
                  <p className="text-[#E50914] font-medium text-xs sm:text-sm mb-2 sm:mb-3">{member.role}</p>
                  <p className="text-xs sm:text-sm text-gray-400 leading-relaxed mb-3 sm:mb-5 hidden sm:block">
                    {member.description}
                  </p>
                  ...
                  <div className="flex items-center justify-center gap-2 sm:gap-3">
                    <a
                      ...
                      className="w-8 h-8 sm:w-10 sm:h-10 bg-white/10 hover:bg-[#E50914] rounded-full flex items-center justify-center transition-colors duration-300"
                      aria-label="LinkedIn"
                    >
              ...
              {[
                ...
                >
                  <button
                    ...
                    className="w-full text-left p-4 sm:p-6 flex items-center justify-between gap-3 sm:gap-4"
                  >
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">{faq.question}</h3>
                    <ChevronDown
                  ...
                  <div className={`transition-all duration-300 overflow-hidden ${openFaqIndex === index ? 'max-h-64' : 'max-h-0'}`}>
      ...
      <section className="relative py-16 sm:py-24 md:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-10 left-10 w-48 sm:w-64 h-48 sm:h-64 border border-white/10 rounded-full" />
          <div className="absolute bottom-10 right-10 w-64 sm:w-96 h-64 sm:h-96 border border-white/10 rounded-full" />
        </div>
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-8 sm:mb-10 px-2 sm:px-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
              <Link href="/#contact" className="w-full sm:w-auto">
                <Button size="lg" className="bg-white hover:bg-gray-100 text-[#E50914] font-bold px-8 sm:px-10 py-6 sm:py-7 text-base sm:text-lg w-full sm:w-auto">
                  Get Started Today
                </Button>
              </Link>
              <Link href="/" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white/10 font-semibold px-8 sm:px-10 py-6 sm:py-7 text-base sm:text-lg w-full sm:w-auto">
                  Learn More
                </Button>
              </Link>
            </div>
